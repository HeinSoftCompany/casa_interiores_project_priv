...
**Repositório Oficial:** [github.com/heinsoft/casa-interiores](https://github.com/heinsoft/casa-interiores)  
**Website Oficial:** [casainteriores.heinsoft.com.br](https://casainteriores.heinsoft.com.br)
...
│
├── /docs
│ ├── Contrato_Desenvolvimento.pdf
│ ├── Politica_Privacidade.pdf
│ ├── Termos_Uso.pdf
│ ├── Certificado_Qualidade_HeinSoft.pdf
...
| -------------- | ---------------------------------- | ------------------------------------- |
| **Cores**      | #E6D5C3, #A27855, #3E3E3E, #FFFFFF | Paleta natural e acolhedora           |
| **Tipografia** | Poppins / Open Sans                | Equilíbrio entre modernidade e leveza |
| **Ícones**     | Line Awesome                       | Ícones consistentes e leves           |
| **Layout**     | Grid Bootstrap 5.3                 | Base responsiva                       |
| **Animações**  | AOS.js                             | Suavidade e destaque visual           |

## 🧾 Documentos Oficiais

| Documento                         | Arquivo                            | Descrição                          |
| --------------------------------- | ---------------------------------- | ---------------------------------- |
| Contrato de Desenvolvimento       | Contrato_Desenvolvimento.pdf       | Formaliza escopo, prazos e suporte |
...
Desenvolvido por:
HeinSoft Company — Soluções Digitais Profissionais
🌐 heinsoft.com.br

📧 contato@heinsoft.com.br
...
Responsável Técnico:
Pedro Henrique — CEO & Fundador

“Transformar ideias em experiências digitais reais.”
— Pedro Henrique, CEO da HeinSoft

## 📅 Roadmap de Desenvolvimento

| Fase                           | Descrição                                   | Status |
| ------------------------------ | ------------------------------------------- | ------ |
| 1️⃣ Planejamento & Briefing    | Coleta de informações e definição de escopo | ✅      |
| 2️⃣ Design & Identidade Visual | Criação visual e layout                     | ✅      |
| 3️⃣ Desenvolvimento Técnico    | Implementação e SEO inicial                 | ✅      |
| 4️⃣ Testes & Publicação        | QA, otimização e deploy                     | ✅      |

Duração total: 4 semanas

## 📈 Histórico de Versões (Changelog)

v1.0.0 — Lançamento Inicial (Out/2025)

Estrutura completa e publicação do site

SEO técnico configurado

Certificado HeinSoft emitido

v1.1.0 — Performance Update (Nov/2025)

Otimização de imagens e scripts

Responsividade aprimorada

v1.2.0 — Atualização de Catálogo (Dez/2025)

Inclusão de novos produtos

Revisão visual e animações AOS

v1.3.0 — Revisão de Conteúdo e SEO (Jan/2026)

Atualização de textos e meta descrições

Nova auditoria GTmetrix (96%)
